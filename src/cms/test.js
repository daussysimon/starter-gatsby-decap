  ...
  return class FileControl extends React.Component {
    ...
    handleUrl = (subject) => (e) => {
      ...
      const url = window.prompt(
        this.props.t(`editor.editorWidgets.${subject}.promptUrl`)
      );
    ...
    renderFileLink = (value) => {
      ...
      const text = `${value.slice(0, size / 2)}\u2026${value.slice(
        -(size / 2) + 1
      )}`;
      return (
        ...
        <div>
          ...
          <div>
            ...
            <FileWidgetButtonRemove onClick={this.handleRemove}>
              {t(
                `editor.editorWidgets.${subject}.remove${
                  allowsMultiple ? "All" : ""
                }`
              )}
    ...
    renderNoSelection = (subject) => {
      ...
      return (
        <>
          <FileWidgetButton onClick={this.handleChange}>
            {t(
              `editor.editorWidgets.${subject}.choose${
                this.allowsMultiple() ? "Multiple" : ""
              }`
            )}
          </FileWidgetButton>
        ...
        <div className={classNameWrapper}>
          <span>
            {value
              ...
              : this.renderNoSelection(subject)}
          </span>
        </div>
      );
    }
